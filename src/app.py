...
def main():
    ...
    # Ensure patient information is filled before proceeding
    if not age or not gender:
        st.warning("Please fill out the patient information before proceeding.")
        return

    # Chat input section
    st.subheader("Chat with the System")
    if symptoms := st.chat_input("Enter patient symptoms:"):
        # Ensure symptoms is a valid string
